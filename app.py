    ...
    try:
        ...
        for item in new_transactions:
            rows_to_write.append([
                ...
                "",
                "",
>>>>>>> f7ca01c (Add upload logging and real-use error handling)
                item["account"],
                item["description"],
            ])
...
=======
        ...
        # Write downloadable transaction report
        with open(report_path, mode="w", newline="", encoding="utf-8") as report_file:
            report_writer = csv.writer(report_file)

            report_writer.writerow(["Status", "Date", "Amount", "Account", "Description"])
